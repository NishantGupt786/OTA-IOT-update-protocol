...
echo "Uploading to s3://iot-ota-rtupdate/cli-test/"
aws s3 cp main.tar s3://iot-ota-rtupdate/cli-test/main.tar
aws s3 cp main.tar.sig s3://iot-ota-rtupdate/cli-test/main.tar.sig
aws s3 cp version.yaml s3://iot-ota-rtupdate/cli-test/version.yaml
aws s3 cp version.yaml.sig s3://iot-ota-rtupdate/cli-test/version.yaml.sig
