...
echo "Uploading to s3://iot-ota-rtupdate/class-demo/"
aws s3 cp main.tar s3://iot-ota-rtupdate/class-demo/main.tar
aws s3 cp main.tar.sig s3://iot-ota-rtupdate/class-demo/main.tar.sig
aws s3 cp version.yaml s3://iot-ota-rtupdate/class-demo/version.yaml
aws s3 cp version.yaml.sig s3://iot-ota-rtupdate/class-demo/version.yaml.sig
